	            	              	            	              	            	            	            	            	            	            <!-- MULAI -->
<div style="overflow:hidden;position:relative;padding: 0px;margin: 2px;border: 1px solid #000000;width:180px;height:125px;float:left;">
<!-- PRICE -->
...
Login: http://<?php echo $dnsname;?>
</div>
<!-- LOGIN-->
<!-- BG-->
<div style="overflow: hidden;padding: 0px;float:left;">
<div style="margin-top:-100px;width: 0; height: 0; border-top: 230px solid transparent;border-left: 50px solid transparent;border-right:130px solid #FFAB40; "></div>
</div>
<!-- LOGIN-->
</div>
<!-- AKHIR -->	            	          	            	          	            	          	           	          	           	          